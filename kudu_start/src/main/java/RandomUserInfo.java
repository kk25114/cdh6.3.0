...
public class RandomUserInfo {
     ...
     * @return
     */
    private static String getSex_name(String id) {
        String sex_name = "男";
        if(id != null && !id.isEmpty() && id.length() == 18) {
     ...
     * @return  1表示男，0表示女
     */
    private static String getSex_no(String id) {
        String sex_name = "1";
        if(id != null && !id.isEmpty() && id.length() == 18) {
            int sex = Integer.parseInt(id.substring(16,17));
            if(sex%2 == 0) {
    ...
    public static  String getCity() {
        int index=getNum(0,Cities.mCitiesStrings.length-1);
        String city=Cities.mCitiesStrings[index];
        return city;
    }
    ...
    public static String getOccupation() {
        int index=getNum(0, Cities.occupations.length-1);
        String occupation=Cities.occupations[index];
        return occupation;
    }
     ...
     * @return 0表示未结婚，1表示结婚
     */
    public static int getMarriage() {
        int marriage = 1;
        int index = getNum(0 , 10);
        if(index%2 == 0) {
            marriage = 0;
        }
        return marriage;
     ...
     * @return
     */
    public static String getUserInfo(String bankName) {
        StringBuffer userInfo = new StringBuffer();
        String id = IdCardGenerator.generate();
        String name = getChineseName();
        String sex = getSex_no(id);
        String city = getCity();
        String occupation = getOccupation();
        String tel = getTel();
        String fixPhoneNum = getTel();
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 10; i++) {
            System.out.println(getUserInfo("测试数据"));
        }
    }
}